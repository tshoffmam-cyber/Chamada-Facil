...
const {user} = useAuth()
const {mensagens, eventos, turmas, alunos} = useData()
...
<div style={{width:44,height:44,borderRadius:14,background:'var(--color-primary-light)',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0,fontSize:20}}>{EMOJI_CALENDARIO}</div>
<div style={{flex:1}}>
