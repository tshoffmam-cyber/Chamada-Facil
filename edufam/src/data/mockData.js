...
export const mockTurmas=[
  {id:'t1',nome:'9º Ano A',disciplina:'Matemática',escola:'Escola Estadual Esperança',turno:'Manhã',sala:'12',totalAlunos:32,horarios:[{dia:1,inicio:'07:30',fim:'08:20'},{dia:3,inicio:'07:30',fim:'08:20'},{dia:5,inicio:'09:30',fim:'10:20'}],professorId:'u1'},
  {id:'t2',nome:'8º Ano B',disciplina:'Matemática',escola:'Escola Estadual Esperança',turno:'Manhã',sala:'08',totalAlunos:28,horarios:[{dia:2,inicio:'08:20',fim:'09:10'},{dia:4,inicio:'08:20',fim:'09:10'}],professorId:'u1'},
]
...
export function proximaAulaHoje(professorId){
  const agora=new Date();const dia=agora.getDay();const min=agora.getHours()*60+agora.getMinutes();
  const turmas=mockTurmas.filter(t=>t.professorId===professorId);
  const cands=[];
